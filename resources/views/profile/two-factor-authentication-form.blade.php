    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                ...
                <div class="p-4 mt-4 bg-white max-w-fit">
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-w-xl  mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-gray-700 dark:text-gray-400 rounded-lg">
