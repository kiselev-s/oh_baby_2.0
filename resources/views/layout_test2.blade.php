...
<nav class="navbar navbar-expand-custom navbar-mainbg">
    <a class="navbar-brand navbar-logo" href="#">Oh baby 2.0</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/test2"><i class="fas fa-home"></i>Home</a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="/docs_test2"><i class="far fa-copy"></i>Documents</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/health_test2"><i class="far fa-copy"></i>Health</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/growth_test2"><i class="fa fa-copy"></i>Growth</a>
            </li>
            <li class="nav-item">
