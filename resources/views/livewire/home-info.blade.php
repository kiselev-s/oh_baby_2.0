<div class="flex flex-wrap justify-center sm:justify-between">
    <div class="mb-4 flex items-center bg-gray-50 dark:bg-gray-700 shadow-lg dark:shadow-blue-900 rounded-lg p-5 mr-5">
        <img src="{{URL::asset('/parent.png')}}" alt="boy" width="50">
        <p class="p-3">Parent:</p>
        <p>{{Auth::user()->name}}</p>
    </div>

    <div class="mb-4 bg-gray-50 dark:bg-gray-700 shadow-lg dark:shadow-blue-900 rounded-lg p-5 mr-5">
