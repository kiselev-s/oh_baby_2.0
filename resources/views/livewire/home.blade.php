...
{{--                {{\App\Http\Controllers\ChildController::getCurrentChild(Auth::user()->currentTeam->id)}}--}}
                ...
                <div class="flex">
                    <div class="flex items-center bg-gray-50 shadow-xl sm:rounded-lg p-5 mr-5">
                        <img src="{{URL::asset('/parent.png')}}" alt="boy" width="50">
                        <p class="p-3">Parent:</p>
                        <p>{{Auth::user()->name}}</p>
                    </div>
                    <div class="bg-gray-50 shadow-xl sm:rounded-lg p-5 mr-5">
                    ...
                    <div class="bg-gray-100 shadow-xl sm:rounded-lg p-5 mr-5">
                        <div class="flex items-center">
                    ...
                    <div class="bg-gray-100 shadow-xl sm:rounded-lg p-5">
                        <div class="flex items-center">
